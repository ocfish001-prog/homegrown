...
export interface HomegrownEvent {
  ...
  source: 'eventbrite' | 'sfpl' | 'smcl' | 'sfzoo' | 'calacademy' | '4h' | 'sffun' | 'meetup' | 'manual' | 'hawaii-manual' | 'funcheap' | 'nps' | 'ebparks' | 'bayareakidfun' | 'cahomeschool' | 'contra-costa-ical' | 'eventbrite-sfbay' | 'chabot-ical' | 'lindsay-ical' | 'badm-ical' | 'chn-ical' | 'sjpl-bibliocommons' | 'oakland-bibliocommons' | 'smcl-bibliocommons' | 'hilo-palace-ical' | 'bigislandnow'
  isSaved?: boolean
  tags?: string[]
  ageRange?: AgeRange
}
